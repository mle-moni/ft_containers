...
int		main(void)
{
	...
	ft::list<std::string>	str_ordered_list(str_ordered.begin(), str_ordered.end());
	ft::list<std::string>	str_ordered_list2(str_ordered2.begin(), str_ordered2.end());
	ft::list<std::string>	str_ordered_list3(str_ordered3.begin(), str_ordered3.end());
	ft::list<int>			int_ordered_list(int_ordered.begin(), int_ordered.end());
	ft::list<int>			int_ordered_list2(int_ordered2.begin(), int_ordered2.end());
	ft::list<int>			int_ordered_list3(int_ordered3.begin(), int_ordered3.end());
