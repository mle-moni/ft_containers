...
int		main(void)
{
	...
	ft::vector<int> vector2(vector_begin, vector_end);
	...
	ft::stack<int, ft::vector<int> >	stack1(vector1);
	ft::stack<int, ft::vector<int> >	stack2(vector1);
	ft::stack<int>						stack3(vector2);
	ft::stack<int>						stack4;
