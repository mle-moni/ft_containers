...
int		main(void)
{
	...
	ft::map<std::string, char>	map1(test_1.begin(), test_1.end());
	ft::map<std::string, char>	map2(test_2.begin(), test_2.end());
	ft::map<std::string, char>	map3(map2);
	ft::map<std::string, char>	map4(map2);
