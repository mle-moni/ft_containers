...
int		main(void)
{
	...
	std::map<std::string, char>	empty;
	std::map<char, int>			range_int(test_int.begin(), test_int.end());
	std::map<std::string, char>	range_str(test_str.begin(), test_str.end());
	std::map<char, int>			copy_int(range_int.begin(), range_int.end());
	std::map<std::string, char>	copy_str(range_str.begin(), range_str.end());
