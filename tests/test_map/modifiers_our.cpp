...
int		main(void)
{
	...
	print_map(map1);
	map2.insert(ft::make_pair('G', 133));
	print_map(map2);
	map2.insert(map2.end(), ft::make_pair('Q', 123));
	map2.insert(++(map2.begin()), ft::make_pair('G', 555));
	print_map(map2);
	std::cout << "new element mapped value = " << map1.insert(map1.begin(), ft::make_pair('G', 11))->second << "\n";
	map1.insert(map1.end(), ft::make_pair('g', 12));
	print_map(map1);
	map1.insert(++(map1.begin()), ft::make_pair('A', 112));
	print_map(map1);
	print_map(map2);
	...
	map1.insert(ft::make_pair('r', 1234));
	map1.insert(ft::make_pair('4', 234));
	ft::map<char, int>::iterator	del_end = map1.begin();
	++del_end;
	++del_end;
	...
	print_map(map1);
	map2.insert(ft::make_pair('t', 14));
	map2.insert(ft::make_pair('q', 34));
	...
	ft::map<char, int>	empty_map1;
	ft::map<char, int>	empty_map2;
