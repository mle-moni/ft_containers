...
int		main(void)
{
	...
	ft::vector<int>			fill_int((size_t)5, 42);
	ft::vector<std::string>	fill_str((size_t)5, "yoooo");
	ft::vector<int>			range_int(test_int.begin(), test_int.end());
	ft::vector<std::string>	range_str(test_str.begin(), test_str.end());
	ft::vector<int>			copy_int(range_int.begin(), range_int.end());
	ft::vector<std::string>	copy_str(range_str.begin(), range_str.end());
